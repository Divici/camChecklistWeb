...
export default function ChecklistPage() {
  ...
  function handleSaveEdit(itemId: number) {
    ...
    updateItem.mutate(
      { itemId, data: { text: editText.trim(), priority: editPriority } },
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <select
                            ...
                            className="bg-surface-container px-3 py-1.5 rounded-xl text-sm text-on-surface font-body outline-none ring-1 ring-primary/30 focus:ring-primary"
                          >
                          ...
                          <button onClick={() => handleSaveEdit(item.id)} className="p-2 rounded-full hover:bg-surface-container-high text-primary"><CheckIcon className="w-5 h-5" /></button>
                          <button onClick={cancelEdit} className="p-2 rounded-full hover:bg-surface-container-high text-on-surface-variant"><X className="w-5 h-5" /></button>
                          <button onClick={() => deleteItem.mutate(item.id)} className="p-2 rounded-full hover:bg-error-container text-error"><Trash2 className="w-4 h-4" /></button>
                        </div>
                      </div>
                    ) : (
                      <>
